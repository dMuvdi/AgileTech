...
class CustomTextField extends StatelessWidget {
  const CustomTextField({super.key, required this.hintText, required this.type, this.validator, required this.isPassword, this.onChanged});
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: const Color(0xFFFFE1E1),
